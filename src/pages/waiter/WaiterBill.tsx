...
import { ChevronLeft, Receipt, QrCode, CheckCircle2, Utensils, Printer, ShieldCheck, AlertCircle } from 'lucide-react';
        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
          <div className="bg-white p-8 rounded-[40px] border-2 border-brand/20 shadow-2xl flex flex-col items-center relative overflow-hidden">
              ...
              <button 
                ...
                className="flex items-center gap-3 bg-ink text-white px-8 py-4 rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] hover:bg-brand transition-all shadow-xl active:scale-95"
              >
                <Printer className="w-5 h-5" /> Imprimir Comanda de Saída
              </button>
          </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                   ...
                   >
                     ...
                     <div className="text-center">
                        <p className="text-[9px] font-black uppercase tracking-widest text-ink leading-tight">Imprimir Ticket</p>
                        <p className="text-[8px] font-bold text-ink-muted uppercase tracking-widest leading-tight">Identificação</p>
                     </div>
                   </button>
                   <button 
                    onClick={handlePrintVisitor}
                   ...
                   >
                     ...
                     <div className="text-center">
                        ...
                        <p className="text-[8px] font-bold text-ink-muted uppercase tracking-widest leading-tight">Visitante</p>
                     </div>
                   </button>
                </div>
             </div>
